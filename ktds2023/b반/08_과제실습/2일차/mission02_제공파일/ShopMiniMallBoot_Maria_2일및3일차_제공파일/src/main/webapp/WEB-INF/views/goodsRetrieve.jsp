...
<link rel="stylesheet" href="<c:url value="/css/goodsRetrieve.css"/>">
<script src="<c:url value="/js/jquery-3.3.1.js"/>"></script>
<script src="<c:url value="/js/goodsRetrieve.js"/>"></script>
	...
	<div class="goodsDetail">
		<form name="goodRetrieveForm" method="GET" action="addCart">
			...
			<table>
				...
				<tr>
					<td rowspan="6"><img src="images/items/${item.gImage}.gif"/></td>
					<td>제품코드</td>
					<td>${item.gCode}</td>
				</tr>
				<tr>
